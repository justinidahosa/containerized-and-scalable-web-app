...
module "ecs" {
  ...
  ecs_service_sg_ingress_from_alb = module.alb.alb_sg_id
...
module "route53" {
  ...
  alias_name         = module.cloudfront.cf_domain
  alias_zone_id      = var.cloudfront_zone_id
}
